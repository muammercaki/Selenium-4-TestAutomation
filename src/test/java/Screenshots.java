...
public class Screenshots {
    ...
    public void takeWebElementScreenShot() throws IOException {
        ...
        File destination = new File("Next Genaration Platfrom.png");
        FileHandler.copy(source, destination);
    }

    @Test
    public void takeWebElementPageScreenShot() throws IOException {
        ...
        FileUtils.copyFile(source, new File("Applitools Page Sectiopn.png"));
    }

    @Test
    public void takeFullPageScreenShot() throws IOException {
        File source = ((FirefoxDriver) driver).getFullPageScreenshotAs(OutputType.FILE);
        FileHandler.copy(source, new File("Applitools Full Page ScreenShoot.png"));
